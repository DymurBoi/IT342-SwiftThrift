...
export default function LoginPage() {
  ...
  const handleSignup = async (e) => {
    ...
    // Phone number validation: must be 11 digits, only numbers, start with 09
    const phone = signupData.phone
    if (!/^(09)\d{9}$/.test(phone)) {
      setError("Phone number must be 11 digits, start with '09', and contain only numbers (e.g., 09123456789).")
      return
    }
